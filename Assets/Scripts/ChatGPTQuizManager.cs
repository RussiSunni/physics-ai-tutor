...
public class ChatGPTQuizManager : MonoBehaviour
{
    [SerializeField]
    ...
    IEnumerator CallChatGPT()
    {
        ...
        userMessage.content = "Ask an exam question from the physics school syllabus to the student.";
    ...
    public void ProvideQuizQuestion()
    {
